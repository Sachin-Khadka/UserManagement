	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        try (PrintWriter out = response.getWriter()) 
        {
        	try {
				...
				if (userName.isEmpty()) {
				...
				else if (admin.checkName(userName) == true) {
					...
					if (userPassword.equals(userConformPassword)) {
						...
						admin = new User(userName, userEmail, userPassword, userConformPassword, userPhone,
								"default.jpg", userAddress, "admin", "active");
						Session hibernateSession = FactoryProvider.getFactory().openSession();
						Transaction tx = hibernateSession.beginTransaction();
						int userId = (int) hibernateSession.save(admin);
						tx.commit();
						...
						FormattedDateProvider fdp = new FormattedDateProvider();
						 String addAdminDate = fdp.getCurentDate();
					
						
						Session session = FactoryProvider.getFactory().openSession();
						RegisterAdd regadd= new RegisterAdd(userName, "admin","admin", addAdminDate);
						...
						httpSession.setAttribute("intime", addAdminDate);
						
						

						if (admin.checkName(request.getParameter("user_name")) == true) {
